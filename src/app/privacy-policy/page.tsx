        ...
        <div className="w-full max-w-4xl mx-auto py-12 px-4 space-y-12">
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-semibold flex items-center gap-3">
                ...
                1. File Handling & Data Security
              </h2>
              <p className="text-muted-foreground">For tools that require file uploads (PDF, images, documents):</p>
            ...
            <section className="space-y-6">
              ...
              <p className="text-muted-foreground">All tools are free and do not require account registration.</p>
            </section>
            ...
            <section className="space-y-6">
              ...
              <p className="text-muted-foreground">Like most websites, we may collect non-personal technical data, such as:</p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground pl-4">
              ...
              <p className="text-muted-foreground">This information is used only for analytics and improving our tools, never for identification.</p>
            </section>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-semibold flex items-center gap-3">
               ...
               <p className="text-muted-foreground">Some tools may use cookies to:</p>
              <ul className="list-disc list-inside space-y-2 text-muted-foreground pl-4">
                  <li>Remember tool settings</li>
                  <li>Improve performance</li>
                  <li>Analyze usage (Google Analytics or Plausible)</li>
              </ul>
              <p className="text-muted-foreground">Cookies do not store personal information. You may disable cookies in your browser settings.</p>
            </section>
